...
public class Longest_Palindromic_Substring_In_Linear {
    ...
    public static void main(String[] args) {
        String str  = "abc";
        //System.out.println(str.substring(mid-mid/2-1,str.length()-(str.length()-mid))+str.substring(mid+1,mid+mid/2+1));
        System.out.println(LongestPalindromeSubString("babcbabcbaccba"));
    }
